            ...
            <div className="mt-8 bg-green-900/20 border border-green-500/30 rounded-xl p-8 font-mono text-sm">
              ...
              <div className="space-y-4 text-green-200">
                <p>
                  ...
                  <strong>LOCATION:</strong> Brooklyn Underground Facility<br/>
                  <strong>CLASSIFICATION:</strong> EYES ONLY
                </p>

                <p>
                  At approximately 2:47 AM, DJ Subject Z-B initiated what he termed a "Disco House Paradox." 
                  Witnesses report a temporal rupture in the space-time continuum, manifesting as uncontrollable 
                  dancing and reports of "feeling the groove in their soul."
                </p>

                <p>
                  <strong>ANOMALOUS EFFECTS OBSERVED:</strong>
                  <br/>• Spontaneous disco ball manifestations
                  <br/>• Temporal loops in musical phrases
                  <br/>• Witnesses claim to have seen John Travolta
                  <br/>• Unexplained urges to wear platform shoes
                </p>

                <p>
                  The mix appears to contain what our scientists can only describe as "pure groove energy" 
                  concentrated into audible frequencies. Dr. ████████ from the Department of Rhythmic Sciences 
                  noted that the track contains "impossible beat patterns that shouldn't exist in our dimension."
                </p>
      ...
      <section className="py-20 bg-black">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-16 text-white">
            Incident <span className="text-amber-500">Timeline</span>
          </h2>
          ...
          <div className="space-y-8">
            {[
              {
                time: "2:47 AM",
                event: "Initial Groove Disturbance",
                description: "First reports of temporal anomalies during opening sequence"
              },
              {
                time: "3:15 AM",
                event: "Disco Ball Manifestation",
                description: "Unexplained appearance of ethereal disco balls throughout venue"
              },
              {
                time: "3:42 AM",
                event: "Peak Paradox Event",
                description: "Reality briefly reorganized itself around a perfect disco house loop"
              },
              {
                time: "4:23 AM",
                event: "Groove Singularity",
                description: "All witnesses simultaneously achieved perfect synchronization"
              },
              {
                time: "5:01 AM",
