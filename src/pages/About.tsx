  ...
  return (
    <Layout>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="bg-primary/10 border border-primary/20 rounded-xl p-8 mb-16">
            <div className="flex flex-col md:flex-row items-center justify-between">
              ...
              <button className="mt-4 md:mt-0 bg-primary text-primary-foreground px-6 py-3 rounded-lg font-semibold hover:bg-primary/90 transition-colors flex items-center gap-2">
          ...
          <div className="bg-gray-900/50 rounded-xl p-8 mb-16">
            <h2 className="text-3xl font-bold text-primary mb-6">Quick Bio (For Event Listings)</h2>
      ...
      <section className="py-20 bg-black">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-16 text-white">
            Press & <span className="text-primary">Highlights</span>
          </h2>
          ...
          <div className="bg-gray-900/30 rounded-xl p-8">
            <h3 className="text-2xl font-bold text-primary mb-6">Career Highlights</h3>
      ...
      <section className="py-20 bg-gradient-to-b from-black to-gray-900">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-16 text-white">
            The <span className="text-primary">Complete Story</span>
          </h2>

          <div className="prose prose-lg prose-invert max-w-none">
            <div className="bg-gray-900/30 rounded-xl p-8 mb-8">
              <p className="text-gray-200 leading-relaxed mb-6">
                <strong className="text-primary">Zack Bissell</strong> isn't just a DJ—he's a sonic architect, a narrative craftsman, and Brooklyn's most compelling storytelling force behind the decks. With roots that stretch from Broadway stages to underground warehouse raves, Zack brings a unique theatrical sensibility to electronic music that transforms every set into an unforgettable cinematic experience.
              </p>
              ...
              <p className="text-gray-200 leading-relaxed mb-6">
                As the founder and creative director of <strong className="text-primary">Lab Obsidian</strong>, Zack has created more than just a record label—it's a creative engine that supports emerging artists and pushes the boundaries of what electronic music can be. This platform allows him to nurture new talent while developing his own artistic vision, creating a ecosystem of innovation that extends far beyond his individual performances.
              </p>
      ...
      <section className="py-20 bg-black">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-primary text-primary-foreground px-8 py-4 rounded-lg text-xl font-semibold hover:bg-primary/90 transition-colors flex items-center justify-center gap-2">
              <Download className="w-6 h-6" />
              Download Full EPK
            </button>
            <a 
              href="/booking"
              className="border-2 border-primary text-primary px-8 py-4 rounded-lg text-xl font-semibold hover:bg-primary hover:text-primary-foreground transition-colors flex items-center justify-center gap-2"
            >
